...
MainWindow::MainWindow(QWidget *parent)
  ...
  connect(this, &MainWindow::signal, graph, &GraphWidget::slot);
    ...
    connect(ui->pushButton_right_bracket,SIGNAL(clicked()),this,SLOT(digits_numbers()));
    ...
    connect(ui->pushButton_scale,SIGNAL(clicked()),this,SLOT(digits_numbers()));
...
void MainWindow::digits_numbers()
{
   ...
   if(ui->result_show->hasFocus())
   {
       ...
       if((new_lable=="sin")||(new_lable=="cos")||
          (new_lable=="acos")||(new_lable=="asin")||
          (new_lable=="tan")||(new_lable=="atan")||
           (new_lable=="log")||(new_lable=="ln")||
           (new_lable=="sqrt")){
...
void MainWindow::on_pushButton_del_clicked()
{
    ...
    if(((new_lable.isEmpty())||(new_lable=="0."))&&(ui->value_x->hasFocus())){
        ui->value_x->setText("0.0");
    }
