...
*/
  ...
  /*!
  Defines to which rect of a layout element the size constraints that can be set
  via \ref setMinimumSize and \ref setMaximumSize apply. The outer rect (\ref
  outerRect) includes the margins (e.g. in the case of a QCPAxisRect the axis
...
class QCP_LIB_DECL QCPLayoutGrid : public QCPLayout {
 ...
 public:
  ...
  addElement(QCPLayoutElement*). The column/row at which wrapping into the next
  row/column occurs can be specified with \ref setWrap.
...
class QCP_LIB_DECL QCPLineEnding {
 ...
 public:
  ...
  The width and length of these decorations can be controlled with the functions
  \ref setWidth and \ref setLength. Some decorations like \ref esDisc, \ref
  esSquare, \ref esDiamond and \ref esBar only support a width, the length
  property is ignored.
...
class QCP_LIB_DECL QCPAxisTicker {
 ...
 public:
  /*!
  Defines the strategies that the axis ticker may follow when choosing the size
  of the tick step.
...
class QCP_LIB_DECL QCPAxis : public QCPLayerable {
 ...
 public:
  /*!
  Defines at which side of the axis rect the axis will appear. This also affects
  how the tick marks are drawn, on which side the labels are placed etc.
*/
  enum AxisType {
...
class QCP_LIB_DECL QCPScatterStyle {
 ...
 public:
  ...
  QCPSelectionDecorator::setScatterStyle will be used when highlighting selected
  data points.
...
*/
  enum PositionType {
    ...
    ///< axis rect by providing negative coordinates or coordinates larger
    ///< than 1.
    ,
...
*/
  ...
  /*!
  Defines the available presets that can be loaded with \ref loadPreset. See the
  documentation there for an image of the presets.
*/
  enum GradientPreset {
...
class QCP_LIB_DECL QCPSelectionDecoratorBracket : public QCPSelectionDecorator {
 ...
 public:
  ...
  Some of the bracket styles further allow specifying a height and/or width, see
  \ref setBracketHeight and \ref setBracketWidth.
*/
  enum BracketStyle {
...
class QCP_LIB_DECL QCPGraph : public QCPAbstractPlottable1D<QCPGraphData> {
 ...
 public:
  /*!
  Defines how the graph's line is represented visually in the plot. The line is
  drawn with the current pen of the graph (\ref setPen). \see setLineStyle
*/
  enum LineStyle {
...
class QCP_LIB_DECL QCPCurve : public QCPAbstractPlottable1D<QCPCurveData> {
 ...
 public:
  /*!
  Defines how the curve's line is represented visually in the plot. The line is
  drawn with the current pen of the curve (\ref setPen). \see setLineStyle
*/
  enum LineStyle {
...
class QCP_LIB_DECL QCPBarsGroup : public QObject {
 ...
 public:
  /*!
  Defines the ways the spacing between bars in the group can be specified. Thus
  it defines what the number passed to \ref setSpacing actually means.
...
class QCP_LIB_DECL QCPItemTracer : public QCPAbstractItem {
 ...
 public:
  /*!
  The different visual appearances a tracer item can have. Some styles size may
